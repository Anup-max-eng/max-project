<section class="fslider">
		<div class="slider">
		    ...
		    <li>
		        ...
		        <h3 style="font-size: 3rem !important; font-style: bold !important; font-family: 'Bree Serif', serif;">RestroGrill - Taste Quality Food!</h3>  
		        <h5 class="light black-text text-lighten-3"><strong>We deliver the golden table experience !</strong></h5>  
		      </div>  
		    </li>
